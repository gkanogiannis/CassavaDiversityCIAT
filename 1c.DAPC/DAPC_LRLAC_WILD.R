...
setwd("D:\\agkanogiannis\\Downloads")

vcf <- read.vcfR("LRLAC_WILD.snps.filt_info_dp3_mac5_den90_imis50_nonrelated-2.vcf.gz")
...
snmf_grp<-read.csv("LRLAC_WILD_nonrelated-2.2pop.sorted.txt",
                   sep="\t", row.names=1, 
